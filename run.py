...
if len(sys.argv) != 5:
    print("usage: python run.py json_file bucket_db_location rn_db_location", "generation_report_location")
    quit()
...
dispatcher(mol_entries, sys.argv[2], sys.argv[3], sys.argv[4])
